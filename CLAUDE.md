...
- `KUBECTL_VERSION`: Kubernetes CLI version (v1.35.0)
- `K9S_VERSION`: Kubernetes cluster management UI version (v0.50.18)
- `GLAB_VERSION`: GitLab CLI version (v1.81.0)
- `HELM_VERSION`: Kubernetes package manager (v3.20.0)
- `ARGO_VERSION`: Argo Workflows CLI (v3.7.8)
- `TERRAFORM_VERSION`: Default Terraform version (1.14.3)
- `TERRAFORM_VERSION_157`: Alternative Terraform version (1.5.7)
- `AWSCLI_VERSION`: AWS CLI v2 version (2.33.5)
- `BOTO3_VERSION`: AWS SDK for Python version (1.42.33)
